...
const getInitialFormData = (): FormData => {
  ...
  Object.values(FORM_SECTIONS).forEach(section => {
    section.forEach(field => {
      if (field.value !== undefined && field.name !== "LOGO") {
...
const FORM_SECTIONS: Record<number, FieldConfig[]> = {
  1: [
    { id: "razonSocial", name: "INSERTAR RAZÓN SOCIAL DE LA EMPRESA", label: "Razón Social de la Empresa", placeholder: "Ingrese la razón social", value: "ESERVICES S.A DE C.V" },
    { id: "rfc", name: "INSERTAR RFC DE LA EMPRESA", label: "RFC de la Empresa", placeholder: "Ingrese el RFC de la empresa", maxLength: 13 },
  ...
  2: [
    { id: "cantidadTotalTrabajadores", name: "CANTIDAD TOTAL DE TRABAJADORES", label: "Cantidad Total de Trabajadores", type: "number", placeholder: "Ingrese la cantidad total de trabajadores", min: "1" },
  ...
  7: [
    ...
    { id: "regularLitros", name: "REGULAR LITROS", label: "Cantidad de Litros almacenados del tanque 1", type: "number", placeholder: "Ingrese la cantidad de litros del tanque 1", step: "0.01", min: "0" },
    ...
    { id: "premiumLitros", name: "PREMIUM LITROS", label: "Cantidad de Litros almacenados del tanque 2", type: "number", placeholder: "Ingrese la cantidad de litros del tanque 2", step: "0.01", min: "0" },
    ...
    { id: "dieselLitros", name: "DIESEL LITROS", label: "Cantidad de Litros almacenados del tanque 3", type: "number", placeholder: "Ingrese la cantidad de litros del tanque 3", step: "0.01", min: "0" },
    { id: "headingTanques45", name: "heading", label: "En caso de que exista un 4TO y 5TO tanque, rellenar los datos.", type: "heading" },
    { id: "ext4", name: "EXT4", label: "Tanque 4 (Si es que existe)", placeholder: "Ingrese información del tanque 4" },
    ...
    { id: "regularLitros4", name: "REGULAR LITROS 4", label: "Cantidad de Litros almacenados del tanque 4", type: "number", placeholder: "Ingrese la cantidad de litros del tanque 4", step: "0.01", min: "0" },
    { id: "ext5", name: "EXT5", label: "Tanque 5 (Si es que existe)", placeholder: "Ingrese información del tanque 5" },
    ...
    { id: "premiumLitros5", name: "PREMIUM LITROS 5", label: "Cantidad de Litros almacenados del tanque 5", type: "number", placeholder: "Ingrese la cantidad de litros del tanque 5", step: "0.01", min: "0" },
  ],
  8: [
    ...
    { id: "xtipoCom1", name: "XTIPOCOMLITROS1", label: "Cantidad de Combustible almacenado del tanque Bipartido 1", type: "number", placeholder: "Ingrese la cantidad de litros del tipo de combustible bipartido 1", step: "0.01", min: "0" },
    ...
    { id: "xtipoCom2", name: "XTIPOCOMLITROS2", label: "Cantidad de Combustible almacenado del tanque Bipartido 2", type: "number", placeholder: "Ingrese la cantidad de litros del tipo de combustible bipartido 2", step: "0.01", min: "0" },
  ...
  9: [
    ...
    { id: "oficinasM2", name: "OFICINAS M2", label: "Superficie del área 1 en m2", type: "number", placeholder: "Ingrese los m2 de oficinas", step: "0.01" },
    { id: "oficinasPorc", name: "OFICINAS %", label: "Superficie del área 1 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje de oficinas", step: "0.01", min: "0", max: "100" },
    { id: "oficinas2", name: "INSERTAR NOMBRE DEL AREA 2", label: "Nombre de Area 2", placeholder: "Ingrese información de área 2" },
    { id: "areaM2", name: "AREA M2", label: "Superficie del área 2 en m2", type: "number", placeholder: "Ingrese los m2 del área", step: "0.01" },
    { id: "areaPorc", name: "AREA %", label: "Superficie del área 2 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área", step: "0.01", min: "0", max: "100" },
    { id: "area3", name: "INSERTAR NOMBRE DEL AREA 3", label: "Nombre de Area 3", placeholder: "Ingrese información de área 3" },
    { id: "area3M2", name: "AREA 3 M2", label: "Superficie del área 3 en m2", type: "number", placeholder: "Ingrese los m2 del área 3", step: "0.01" },
    { id: "area3Porc", name: "AREA 3 %", label: "Superficie del área 3 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área 3", step: "0.01", min: "0", max: "100" },
    { id: "area4", name: "INSERTAR NOMBRE DEL AREA 4", label: "Nombre de Area 4", placeholder: "Ingrese información de área 4" },
    { id: "area4M2", name: "AREA 4 M2", label: "Superficie del área 4 en m2", type: "number", placeholder: "Ingrese los m2 del área 4", step: "0.01" },
    { id: "area4Porc", name: "AREA 4 %", label: "Superficie del área 4 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área 4", step: "0.01", min: "0", max: "100" },
    { id: "area5", name: "INSERTAR NOMBRE DEL AREA 5", label: "Nombre de Area 5", placeholder: "Ingrese información de área 5" },
    { id: "area5M2", name: "AREA 5 M2", label: "Superficie del área 5 en m2", type: "number", placeholder: "Ingrese los m2 del área 5", step: "0.01" },
    { id: "area5Porc", name: "AREA 5 %", label: "Superficie del área 5 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área 5", step: "0.01", min: "0", max: "100" },
    { id: "area6", name: "INSERTAR NOMBRE DEL AREA 6", label: "Nombre de Area 6", placeholder: "Ingrese información de área 6" },
    { id: "area6M2", name: "AREA 6 M2", label: "Superficie del área 6 en m2", type: "number", placeholder: "Ingrese los m2 del área 6", step: "0.01" },
    { id: "area6Porc", name: "AREA 6 %", label: "Superficie del área 6 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área 6", step: "0.01", min: "0", max: "100" },
    { id: "area7", name: "INSERTAR NOMBRE DEL AREA 7", label: "Nombre de Area 7", placeholder: "Ingrese información de área 7" },
    { id: "area7M2", name: "AREA 7 M2", label: "Superficie del área 7 en m2", type: "number", placeholder: "Ingrese los m2 del área 7", step: "0.01" },
    { id: "area7Porc", name: "AREA 7 %", label: "Superficie del área 7 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área 7", step: "0.01", min: "0", max: "100" },
    { id: "area8", name: "INSERTAR NOMBRE DEL AREA 8", label: "Nombre de Area 8", placeholder: "Ingrese información de área 8" },
    { id: "area8M2", name: "AREA 8 M2", label: "Superficie del área 8 en m2", type: "number", placeholder: "Ingrese los m2 del área 8", step: "0.01" },
    { id: "area8Porc", name: "AREA 8 %", label: "Superficie del área 8 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área 8", step: "0.01", min: "0", max: "100" },
  ],
  10: [
    { id: "area9", name: "INSERTAR NOMBRE DEL AREA 9", label: "Nombre de Area 9", placeholder: "Ingrese información de área 9" },
    { id: "area9M2", name: "AREA 9 M2", label: "Superficie del área 9 en m2", type: "number", placeholder: "Ingrese los m2 del área 9", step: "0.01" },
    { id: "area9Porc", name: "AREA 9 %", label: "Superficie del área 9 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área 9", step: "0.01", min: "0", max: "100" },
    { id: "area10", name: "INSERTAR NOMBRE DEL AREA 10", label: "Nombre de Area 10", placeholder: "Ingrese información de área 10" },
    { id: "area10M2", name: "AREA 10 M2", label: "Superficie del área 10 en m2", type: "number", placeholder: "Ingrese los m2 del área 10", step: "0.01" },
    { id: "area10Porc", name: "AREA 10 %", label: "Superficie del área 10 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área 10", step: "0.01", min: "0", max: "100" },
    { id: "area11", name: "INSERTAR NOMBRE DEL AREA 11", label: "Nombre de Area 11", placeholder: "Ingrese información de área 11" },
    { id: "area11M2", name: "AREA 11 M2", label: "Superficie del área 11 en m2", type: "number", placeholder: "Ingrese los m2 del área 11", step: "0.01" },
    { id: "area11Porc", name: "AREA 11 %", label: "Superficie del área 11 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área 11", step: "0.01", min: "0", max: "100" },
    { id: "area12", name: "INSERTAR NOMBRE DEL AREA 12", label: "Nombre de Area 12", placeholder: "Ingrese información de área 12" },
    { id: "area12M2", name: "AREA 12 M2", label: "Superficie del área 12 en m2", type: "number", placeholder: "Ingrese los m2 del área 12", step: "0.01" },
    { id: "area12Porc", name: "AREA 12 %", label: "Superficie del área 12 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área 12", step: "0.01", min: "0", max: "100" },
    { id: "area13", name: "INSERTAR NOMBRE DEL AREA 13", label: "Nombre de Area 13", placeholder: "Ingrese información de área 13" },
    { id: "area13M2", name: "AREA 13 M2", label: "Superficie del área 13 en m2", type: "number", placeholder: "Ingrese los m2 del área 13", step: "0.01" },
    { id: "area13Porc", name: "AREA 13 %", label: "Superficie del área 13 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área 13", step: "0.01", min: "0", max: "100" },
    { id: "area14", name: "INSERTAR NOMBRE DEL AREA 14", label: "Nombre de Area 14", placeholder: "Ingrese información de área 14" },
    { id: "area14M2", name: "AREA 14 M2", label: "Superficie del área 14 en m2", type: "number", placeholder: "Ingrese los m2 del área 14", step: "0.01" },
    { id: "area14Porc", name: "AREA 14 %", label: "Superficie del área 14 en porcentaje (%)", type: "number", placeholder: "Ingrese el porcentaje del área 14", step: "0.01", min: "0", max: "100" },
  ...
  11: [
    ...
    { id: "disp4", name: "DISP4", label: "Dispensario 4", placeholder: "Ingresar solo el numero del dispensario (4)" },
    ...
    { id: "disp5", name: "DISP5", label: "Dispensario 5", placeholder: "Ingresar solo el numero del dispensario (5)" },
    ...
    { id: "disp6", name: "DISP6", label: "Dispensario 6", placeholder: "Ingresar solo el numero del dispensario (6)" },
    ...
    { id: "disp7", name: "DISP7", label: "Dispensario 7", placeholder: "Ingresar solo el numero del dispensario (7)" },
    ...
    { id: "disp8", name: "DISP8", label: "Dispensario 8", placeholder: "Ingresar solo el numero del dispensario (8)" },
  ...
  12: [
    { id: "disp9", name: "DISP9", label: "Dispensario 9", placeholder: "Ingresar solo el numero del dispensario (9)" },
    ...
    { id: "disp10", name: "DISP10", label: "Dispensario 10", placeholder: "Ingresar solo el numero del dispensario (10)" },
    ...
    { id: "disp11", name: "DISP11", label: "Dispensario 11", placeholder: "Ingresar solo el numero del dispensario (11)" },
    ...
    { id: "disp12", name: "DISP12", label: "Dispensario 12", placeholder: "Ingresar solo el numero del dispensario (12)" },
    ...
    { id: "disp13", name: "DISP13", label: "Dispensario 13", placeholder: "Ingresar solo el numero del dispensario (13)" },
    ...
    { id: "disp14", name: "DISP14", label: "Dispensario 14", placeholder: "Ingresar solo el numero del dispensario (14)" },
    ...
    { id: "disp15", name: "DISP15", label: "Dispensario 15", placeholder: "Ingresar solo el numero del dispensario (15)" },
